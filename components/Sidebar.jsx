...
const Sidebar = ({ expand, setExpand }) => {
  const { openSignIn = useClerk() } = useClerk();
      ...
      <div>
        ...
        >
          ...
          <div
            ...
            className="group relative items-center justify-center hover:bg-gray-500/20 transition-all duration-300 h-9 w-9 apect-square rounded-lg cursor-pointer"
          >
        ...
        <div
          className={`mt-8 text-white/25 ytext-sm ${
            expand ? "block" : "hidden"
          }`}
        >
